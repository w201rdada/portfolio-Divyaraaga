...
Our solution needs details of the customer\'s current package, viewing patterns of the customer and channel catalog data from Offers Management System. This data is used by the solution to compute the list of \"N\" most watched channels by the customer. This data will be presented to the customer service representative in a chart with a filter to control \"N\" (for e.g.: Top 5 Channels, Top 10 Channels etc.).
...
knitr::include_graphics('img/latest_Arch.png')
```
...
We are enabling our customer support teams to serve customers better using this data driven solution. Offering generalized retention packages to the customer will seem mechanical, whereas offering to build a customized package for the customer will help the representative to establish a better connection with the customer. Thus, the odds of retaining the customer will increase.
